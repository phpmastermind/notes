...
const projectId = 'speechnotes-153412';

var methods = {};

// [START speech_sync_recognize]
methods.syncRecognize = function(filename, callback) {
...
methods.asyncRecognize = function(filename) {
  console.log(projectId);
  // Instantiates a client
  // Instantiates a client
  const speech = Speech({
...
methods.streamingRecognize = function(filename, callback) {
  console.log(projectId);
  // Instantiates a client
  // Instantiates a client
  const speech = Speech({
...
methods.streamingMicRecognize = function(){
  // Instantiates a client
  const speech = Speech({
    projectId: projectId
  });
